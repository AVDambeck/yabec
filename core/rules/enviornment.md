...
Striking distance. 
### Close
Throwing distance. Speaking distance. With in the same *zone*.
### Distant
Shouting distance. Farthest distance to make out details (in *bright* light). 
...
When a creature with *infravision* stands in *bright*, they are blinded for one round, and their *infravison* is disabled until they spend a full *turn* in the *dark*.
